...
app = FastAPI(title="DotMac Marketing API", lifespan=lifespan)
...
app.include_router(web_channels_router)
app.include_router(web_analytics_router)
app.include_router(web_tasks_router)
app.include_router(web_mkt_settings_router)
